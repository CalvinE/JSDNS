...
describe("utilities", function() {
  it("When encoding a 16 bit number the result should be accurate.", function(){
  ...
  it("When decoding a 16 bit number the result should be accurate.", function(){
  ...
  it("When encoding a 32 bit number the result should be accurate.", function(){
  ...
  it("When decoding a 32 bit number the result should be accurate.", function(){
